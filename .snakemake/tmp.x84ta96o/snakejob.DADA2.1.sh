...
--wait-for-files /home/xinyut/workflows/16s-pipeline/.snakemake/tmp.x84ta96o s3Combine --latency-wait 5 \
 --attempt 1 --force-use-threads \
--wrapper-prefix https://github.com/snakemake/snakemake-wrappers/raw/ \
   --allowed-rules DADA2 --nocolor --notemp --no-hooks --nolock \
--mode 2  && touch "/home/xinyut/workflows/16s-pipeline/.snakemake/tmp.x84ta96o/1.jobfinished" || (touch "/home/xinyut/workflows/16s-pipeline/.snakemake/tmp.x84ta96o/1.jobfailed"; exit 1)
